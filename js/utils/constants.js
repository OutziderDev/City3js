...
export const SNOW_MELT_START_DELAY = 30;
...
export const PLANE_LENGTH = 6;
export const PLANE_WINGSPAN = 8;
export const PLANE_BODY_RADIUS = 0.6;
export const PLANE_COLORS = [
  0xffffff, 0xdddddd, 0xcc2222, 0x2244aa, 0xffcc00
];
